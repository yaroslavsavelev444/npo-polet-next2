...
import { getCartItemCount, getCartProductIds } from "@/payload/services/carts.service";
...
export default async function Navbar() {
  ...
  const [cartItemCount, cartProductIds, wishlistProductIds, unreadNotificationCount] = user
    ? await Promise.all([
