 ...
 *
 * Отображение рейтинга и количества отзывов. rating/reviewsCount приходят из
 * агрегата одобренных отзывов (см. reviews.service + adapter). Когда отзывов
 * нет (reviewsCount === 0), рендерим нейтральную заглушку "Нет отзывов"
 * вместо пустых нулевых звёзд, чтобы не выглядело как баг.
 */
