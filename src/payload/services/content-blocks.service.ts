...
function getContentBlocksCacheKey(
  options: GetContentBlocksOptions = {},
): string {
  const {
    isActive,
    variant,
...
export const getCachedContentBlocks = (
  options: GetContentBlocksOptions = {},
) => {
  ...
  return unstable_cache(fetchFn, [getContentBlocksCacheKey(options)], {
    tags: ["content-blocks"],
...
export const getCachedContentBlockById = (id: string) => {
  ...
  return unstable_cache(fetchFn, [`content-block-${id}`], {
    tags: ["content-blocks"],
    revalidate: false,
  })();
};
...
export const getActiveContentBlocks = (
  options: Omit<GetContentBlocksOptions, "isActive"> = {},
