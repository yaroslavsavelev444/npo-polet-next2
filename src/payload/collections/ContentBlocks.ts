...
export const ContentBlocks: CollectionConfig = {
	...
	hooks: {
		...
		// getCachedContentBlocks кэширует список с revalidate:false — без этого
		// хука новые/изменённые блоки не появлялись бы на сайте до редеплоя.
		afterChange: [createRevalidateCacheHook("content-blocks")],
		afterDelete: [createRevalidateCacheHook("content-blocks")],
	},
	fields: [
		{
			name: "title",
