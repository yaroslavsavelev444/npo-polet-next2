	...
	fields: [
...

		{
			...
			fields: [
				...
				// Собственный номер покупателя. В профиле телефон не хранится, а
				// вводится он при каждом оформлении — без этого поля пользователю
				// пришлось бы набирать его заново на каждый заказ.
				{
					name: "customerPhone",
					type: "text",
